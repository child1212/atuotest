...
# 定义类别字典（根据你的数据集）
class_dict = {'closeButton': 0, 'backButton': 1, 'guideButton':2,'skipButton':3,'mission':4,'useButton':5,'login':6,'okButton':7,'nextButton':8,
              'createButton':9,'keep':10,'guideSwipe':11,'skill':12,'activity':13}  # 更新为你的类别
