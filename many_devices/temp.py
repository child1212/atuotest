...
class DeviceAndroid():
    ...
    def tap(self,position_x,position_y,direction):
        if direction == "0":
            ...
            print("{x} {y}".format(x=position_y*self.size_x//100000,y=self.size_y-position_x*self.size_y//100000))        
            # print("input tap {y} {x}".format(y=self.size_y-position_y*self.size_y//100000,x=self.size_x-position_x*self.size_x//100000))
            # self.adb_d.shell("input tap {x} {y}".format(x=position_x*self.size_x//100000,y=self.size_y-position_y*self.size_y//100000)) 
    ...
    def swipe(self,position_x,position_y,position_x1,position_y1,direction):
        if direction == "0":
            ...
            print(("input swipe {b} {a} {d} {c} ".format(a=self.size_x-position_x*self.size_x//100000,b=position_y*self.size_y//100000,c=self.size_x-position_x1*self.size_x//100000,d=position_y1*self.size_y//100000)))
