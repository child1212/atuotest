                ...
                if search_result[0] == "ABS_MT_POSITION_X":
                    ...
                    if search_result[1] == "DOWN":
                        ...
                        for shouji in devices_list:
                            ...
                            # p = Process(target=shouji.touch_relative_position,args=(position[0],position[1],2))
                            # p.start()
                        position = [0,0]
                if run == 2 :
                    # print("run=2")
                    for shouji in devices_list:
                        ...
                        # p = Process(target=shouji.touch_relative_position,args=(position[0],position[1],action))
                        # p.start()
                    action = 0
                    run=0
