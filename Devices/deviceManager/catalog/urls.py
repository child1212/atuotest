...
urlpatterns = [
    ...
    path('device/dueback',views.due_back, name='dueback'),
    path('devices/filter/',views.devices_filter, name='devices-filter'),
    path('devices/filter/result/',views.filter_result, name='filter-result'),
    path('device/<str:pk>',views.device_detail, name='device-detail'),
    path('device/<str:pk>/borrow/',views.borrow_device, name='borrow'),
    ...
    path('genre/<int:pk>/refresh/',views.device_status, name='genre-refresh'),
